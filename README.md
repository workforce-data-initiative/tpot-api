...
The API spec can be publicly viewed [here](https://app.swaggerhub.com/apis/BrightHive/etp-api) and is hosted [here](https://docs.brighthive.io/v1.0/reference#provider).
